...
TUTORIAIS = [
    {"userinscritos":[],"inscritos":0,"nome": "Desenhando com Python: programação criativa ao alcance de todas as pessoas", "data_hora": "dia 17/10/2021 às 10h", "vagas": "25", "ministrantes": ["Alexandre Villares"]},
    {"userinscritos":[],"inscritos":0,"nome": "Análise de Datasets Científicos usando Python", "data_hora": "dia 16/10/2021 às 10h", "vagas": "100", "ministrantes": ["Bruno dos Santos Almeida"]},
    {"userinscritos":[],"inscritos":0,"nome": "1-Djavue - criando uma aplicação web do zero com Django e Vue.js", "data_hora": "dia 16/10/2021 às 10h", "vagas": "80", "ministrantes": ["Buser (facilitadora: Renzo Nuccitelli)"]},
    {"userinscritos":[],"inscritos":0,"nome": "2-Djavue - criando uma aplicação web do zero com Django e Vue.js", "data_hora": "dia 16/10/2021 às 15h", "vagas": "80", "ministrantes": ["Buser (facilitadora: Renzo Nuccitelli)"]},
    {"userinscritos":[],"inscritos":0,"nome": "Desenvolvimento orientado a testes com Django", "data_hora": "dia 17/10/2021 às 15h", "vagas": "20", "ministrantes": ["Carta (facilitador: Gabriel Saldanha)"]},
    {"userinscritos":[],"inscritos":0,"nome": "Como o dinheiro viaja internacionalmente?", "data_hora": "dia 16/10/2021 às 10h", "vagas": "80", "ministrantes": ["Ebury (facilitador: Gustavo Di Domenico)"]},
    {"userinscritos":[],"inscritos":0,"nome": "Acelerando a exploração de dados multidimensionais com Xarray", "data_hora": "dia 17/10/2021 às 15h", "vagas": "60", "ministrantes": ["Felipe Schuch"]},
    {"userinscritos":[],"inscritos":0,"nome": "Python para microcontroladores com MicroPython", "data_hora": "dia 17/10/2021às 10h", "vagas": "10", "ministrantes": ["Gabriel Aragão"]},
    {"userinscritos":[],"inscritos":0,"nome": "Python Geoespacial: automatizando processos de GIS e Sensoriamento Remoto com pacotes abertos em python", "data_hora": "dia 17/10/2021 às 15h", "vagas": "15", "ministrantes": ["Guilherme Iablonovski"]},
    {"userinscritos":[],"inscritos":0,"nome": "Viajando por uma API protegida: Implementando uma API com Flask", "data_hora": "dia 16/10/2021 às 10h", "vagas": "30", "ministrantes": ["Jessica Temporal"]},
    {"userinscritos":[],"inscritos":0,"nome": "Expectativas nem sempre machucam - Criando expectativas para os seus dados com Great Expectations.", "data_hora": "dia 16/10/2021 às 15h", "vagas": "20", "ministrantes": ["Joamila Brito"]},
    {"userinscritos":[],"inscritos":0,"nome": "Analisando 250GB em segundos usando Python e a Base dos Dados", "data_hora": "dia 16/10/2021 às 10h", "vagas": "10", "ministrantes": ["João Carabetta"]},
    {"userinscritos":[],"inscritos":0,"nome": "Criando um jogo de plataforma com Pygame do zero", "data_hora": "dia 16/10/2021 às 10h", "vagas": "12", "ministrantes": ["João JS Bueno"]},
    {"userinscritos":[],"inscritos":0,"nome": "Python para Dashboards", "data_hora": "dia 17/10/2021 às 15h", "vagas": "30", "ministrantes": ["Jose Edivaldo da Silva Junior"]},
    {"userinscritos":[],"inscritos":0,"nome": "Airflow na Pratica", "data_hora": "dia 16 às 10h", "vagas": "40", "ministrantes": ["JusBrasil (facilitador: Tarsis)"]},
    {"userinscritos":[],"inscritos":0,"nome": "Anatomia de um interpretador Lisp em Python", "data_hora": "dia/10/2021 16 às 15h", "vagas": "30", "ministrantes": ["Luciano Ramalho"]},
    {"userinscritos":[],"inscritos":0,"nome": "Construindo API's robustas utilizando Python", "data_hora": "dia 16/10/2021 às 15h", "vagas": "30", "ministrantes": ["Luizalabs (facilitador: Cassio Botaro)"]},
    {"userinscritos":[],"inscritos":0,"nome": "As luas de Jupyter: widgets e outras ferramentas que o orbitam", "data_hora": "dia 17/10/2021 às 10h", "vagas": "20", "ministrantes": ["Mariana Meireles", "Marcos Pantuza", "Laysa Ucho"]},
    {"userinscritos":[],"inscritos":0,"nome": "Qual produto é o melhor para mim? Comparando produtos usando a API de MELI", "data_hora": "dia 17/10/2021 às 10h", "vagas": "15", "ministrantes": ["Mercado Livre (facilitador: Giovanni Almeida)"]},
    {"userinscritos":[],"inscritos":0,"nome": "Desvendando o código genético com Biopython", "data_hora": "dia 17/10/2021 às 10h", "vagas": "30", "ministrantes": ["Pâmella Araújo Balcaçar"]},
    {"userinscritos":[],"inscritos":0,"nome": "Manipulando Imagens da webCam com python", "data_hora": "dia 17/10/2021 às 15h", "vagas": "40", "ministrantes": ["Ramon Domingos Duarte Oliveira"]},
]
